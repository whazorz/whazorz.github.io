document.addEventListener("DOMContentLoaded", () => {
  ...
  const completedRequestList = document.getElementById("completed-request-items-list"); // NEW
  
  const galleryList = document.getElementById("gallery-items-list");
  const galleryForm = document.getElementById("gallery-form");
  const galleryEditId = document.getElementById("gallery-edit-id"); // NEW
  const gallerySubmitBtn = document.getElementById("gallery-submit-btn"); // NEW
  const galleryCancelBtn = document.getElementById("gallery-cancel-btn"); // NEW
  ...
  const downloadEditId = document.getElementById("download-edit-id"); // NEW
  const downloadSubmitBtn = document.getElementById("download-submit-btn"); // NEW
  const downloadCancelBtn = document.getElementById("download-cancel-btn"); // NEW
